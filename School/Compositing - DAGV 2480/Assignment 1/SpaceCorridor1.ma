...
//Last modified: Fri, Jan 10, 2025 11:55:30 PM
//Codeset: 1252
...
fileInfo "UUID" "B114F26D-4789-1F01-95A7-1CBDD056A99F";
...
createNode fosterParent -n "Sci_fi_CorridorRNfosterParent1";
	rename -uid "4221589F-40CE-EA0E-C57F-7F81B54775D4";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "AC8277C8-4509-DCCA-1031-08A06EB6D678";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7DA5870D-4C34-1204-15D9-A7801DCC9001";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "51B63323-4FBF-57E3-B897-C192B36F7505";
createNode displayLayerManager -n "layerManager";
	rename -uid "FB99FBFF-4647-8A67-9EFB-D3ACA68D8D2D";
createNode displayLayer -n "defaultLayer";
	rename -uid "0D11C027-479D-7CF7-0F75-418A5E50E360";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "91550988-4648-6208-7BEE-788D50F9C023";
