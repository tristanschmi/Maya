...
//Last modified: Thu, Jan 09, 2025 05:50:28 PM
//Codeset: 1252
...
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiMeshLight"
		 -nodeType "aiImagerDenoiserOptix" -nodeType "aiImagerDenoiserOidn" "mtoa" "5.4.2.1";
requires "stereoCamera" "10.0";
...
fileInfo "UUID" "7D977412-4B31-CD56-5D83-D89849A68FEB";
createNode transform -s -n "persp";
	rename -uid "EF776CE0-4EF8-C26C-DAA1-678FB2508DC8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.10466099670848017 203.03203418749402 -1972.8859641711115 ;
	setAttr ".r" -type "double3" -4.1560527450762388 -184.62212787367622 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 1121.3072111838001;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -12.324028015136719 150.82744979858398 -822.71920776367188 ;
...
createNode aiMeshLight -n "light_pCube1Shape" -p "light_pCube1";
	...
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".intensity" 1102.5640869140625;
...
createNode fosterParent -n "Sci_fi_CorridorRNfosterParent1";
	rename -uid "0B6B7610-4DC2-2A2A-5A08-509C3AF3768F";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6F238665-4ED2-7480-F289-01BC213995CB";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9DA79C32-4A6B-A13E-E5FD-C7A3CAD0BA20";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EDA8E0C4-4FEC-CEF2-71B5-13A912C3235A";
createNode displayLayerManager -n "layerManager";
	rename -uid "42DE09BB-4628-FA74-68C2-E6961DB33E76";
createNode displayLayer -n "defaultLayer";
	rename -uid "0D11C027-479D-7CF7-0F75-418A5E50E360";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "09CF7935-48BA-43A2-8C2D-329D8455EDA4";
